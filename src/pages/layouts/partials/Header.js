                ...
                <div className="page-header navbar navbar-fixed-top">
                    <div className="page-header-inner ">
                        ...
                        <div className="col-xs-4">
                            <div className="font-white bold"><span lang="Hello:">Hello: </span><span> AV1202 </span></div>
                            <div className="font-white bold"><span lang="Expires day: ">Expires day: </span><span>29/06/2020 06:59 GMT +7</span></div>
                        </div>
                    </div>
                    <div className="top-menu">
                        <ul className="nav navbar-nav pull-right">
                            ...
                            {/*=======================================================================*/}
                            <li className="dropdown dropdown-extended dropdown-tasks">
                                <MenuCompany/>
                            </li>
                            {/*=======================================================================*/}
