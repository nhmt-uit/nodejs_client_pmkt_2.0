...
import { ListCurrencyComponent, CompanyConfigComponent, AccountantConfigComponent } from 'my-components/manage'
...
class ConfigurationContainer extends Component {
    ...
    render() {
        const { t, configuration, company, accountant } = this.props;
        return (
            <div className="config portlet light bordered">
                ...
                <TabContent activeTab={this.state.activeTab}>
                    ...
                    <TabPane tabId="3">
                        <Row>
                            <Col sm="12">
                                <AccountantConfigComponent accountant={accountant}/>
                            </Col>
                        </Row>
                    </TabPane>
                </TabContent>
...
const mapStateToProps = state => {
    return {
        ...
        accountant: state.ConfigurationReducer.accountant,
    };
};
